...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Alma Mater Studiorum - Università di Bologna"
Config.profilename = "Università di Bologna"
Config.url = "your local eduroam® support page"
Config.email = "	assistenza.cesia@unibo.it"
Config.title = "eduroam CAT"
Config.server_match = "wifi.unibo.it"
...
Config.user_realm = "unibo.it"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:wifi.unibo.it']
